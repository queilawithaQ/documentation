...
CI_BRANCH #The branch from which the commit was triggered. Ex: master
...
CI_COMMITTER_EMAIL #The committer's email address used by the SCM.
CI_COMMITTER_NAME #The committer's name used by the SCM.
CI_COMMITTER_USERNAME #The committer's username used by the SCM.
CI_COMMIT_ID #The commit ID used by the SCM. 
...
CI_NAME #This will always say CodeShip. 
...
CI_REPO_NAME #The repository name used in the SCM.
```
