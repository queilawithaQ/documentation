...
Google Chrome is at version 83 and is located at `/usr/bin/google-chrome`.

Chromium is at version 83 and is located at `/usr/bin/chromium-browser`.
...
[ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver) 83.0.4103.39 is installed by default and available in the PATH.
