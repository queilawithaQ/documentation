...
Google Chrome is at version 85 and is located at `/usr/bin/google-chrome`.
...
[ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver) 85.0.4183.87 is installed by default and available in the PATH.
