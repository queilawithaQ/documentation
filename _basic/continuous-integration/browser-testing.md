...
Google Chrome is at version 84 and is located at `/usr/bin/google-chrome`.
...
[ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver) 84.0.4147.30 is installed by default and available in the PATH.
