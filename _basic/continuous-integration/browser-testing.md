...
Google Chrome is at version 74 and is located at `/usr/bin/google-chrome`.
...
[ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver) 74.0.3729.6 is installed by default and available in the PATH.
