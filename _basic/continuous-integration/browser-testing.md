...
Google Chrome is at version 79 and is located at `/usr/bin/google-chrome`.
...
[ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver) 79.0.3945.36 is installed by default and available in the PATH.
