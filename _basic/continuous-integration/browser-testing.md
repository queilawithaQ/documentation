...
Google Chrome is at version 81 and is located at `/usr/bin/google-chrome`.
...
[ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver) 81.0.4044.69 is installed by default and available in the PATH.
