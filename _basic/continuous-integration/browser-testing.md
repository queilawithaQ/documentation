...
Google Chrome is at version 70 and is located at `/usr/bin/google-chrome`.
...
[ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver) 2.43 is installed by default and available in the PATH.
