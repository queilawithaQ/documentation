...
Chromium is at version 77 and is located at `/usr/bin/chromium-browser`.
...
[ChromeDriver](https://sites.google.com/a/chromium.org/chromedriver) 78.0.3904.70 is installed by default and available in the PATH.
