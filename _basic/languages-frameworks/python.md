...
By default, we run Python version `2.7`, but versions `3.4`, `3.5`, `3.6`, `3.7` and `3.8` are preinstalled as well. These are aliases that are pointing to the specific versions installed.
